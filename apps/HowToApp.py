...
class HowToApp(HydraHeadApp):
    ...
    def run(self):
        ...
        st.image('resources/webp1.png', width = 1000)
        st.write('##')
        st.write('##')
        st.write('##')
        st.write('##')
        ...
        st.image('resources/webp2.png', width = 1000)
        st.write('##')
        st.write('##')
        st.write('##')
        st.write('##')
        ...
        st.image('resources/webp3.png', width = 1000)
        st.write('##')
        st.write('##')
        st.write('##')
        st.write('##')
        ...
        st.image('resources/webp4.png', width = 1000)
        st.write('##')
        st.write('##')
        st.write('##')
        st.write('##')
